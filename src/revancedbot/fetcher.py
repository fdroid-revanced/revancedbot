...
WINDOW_WIDTH = "1920"
WINDOW_HEIGHT = "1080"
DOWNLOAD_CHECK_INTERVAL_SEC = 1
POST_DOWNLOAD_WAIT_SEC = 5
...
class ApkpureFetcher():
    ...
    def wait_settle(self):
        ...
        logger.info(f"Downloads finished, waiting for {POST_DOWNLOAD_WAIT_SEC}s")
        time.sleep(POST_DOWNLOAD_WAIT_SEC)
        self.driver.close()
